...
@section('title', 'Agregar afiliado')

@section('content_header')
    <h1><span class="font-weight-bold">CloudTravel</span> | Agregar afiliado</h1>
@stop

@section('content')

<div class="card col-12">
    <form action="{{ route('afiliados.store') }}" method="post" id="form-agregar-afiliado">
        @csrf
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" name="nombre_comercial" required class="form-control" placeholder="Ingresar Nombre comercial">
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
                <div class="form-group">
                    <label>Dirección comercial</label>
                    <input type="text" name="direccion_comercial" required class="form-control" placeholder="Ingresar Dirección comercial">
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-12">
                <div class="form-group">
                    <label>País</label>
                    <input type="text" name="pais_comercial" class="form-control" placeholder="Ingresar Código postal">
                </div>
            </div>
            <div class="col-md-3 col-sm-12">
                <div class="form-group">
                    <label>Estado</label>
                    <input type="text" name="estado_comercial" class="form-control" placeholder="Ingresar Código postal">
                </div>
            </div>
            <div class="col-md-3 col-sm-12">
                <div class="form-group">
                    <label>Ciudad</label>
                    <input type="text" name="ciudad_comercial" class="form-control" placeholder="Ingresar Código postal">
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
                <div class="form-group">
                    <label>Nombre Fiscal</label>
                    <input type="text" name="razon_social" class="form-control" placeholder="Ingresar Nombre Fiscal">
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
                <div class="form-group">
                    <label>Dirección Fiscal</label>
                    <input type="text" name="direccion_fiscal" class="form-control" placeholder="Ingresar Dirección Fiscal">
                </div>
            </div>
            <div class="col-md-3 col-sm-12">
                <div class="form-group">
            ...
            <div class="col-md-3 col-sm-12">
                <div class="form-group">
                    <label>País</label>
                    <input type="text" name="pais_fiscal" class="form-control" placeholder="Ingresar Código postal">
                </div>
            </div>
            <div class="col-md-3 col-sm-12">
                <div class="form-group">
                    <label>Estado</label>
                    <input type="text" name="estado_fiscal" class="form-control" placeholder="Ingresar Código postal">
                </div>
            </div>
            <div class="col-md-3 col-sm-12">
                <div class="form-group">
                    <label>Ciudad</label>
                    <input type="text" name="ciudad_fiscal" class="form-control" placeholder="Ingresar Código postal">
                </div>
            </div>
            <div class="col-md-4 col-sm-12">
                <div class="form-group">
                    <label>RFC</label>
                    <input type="text" name="rfc" required class="form-control" placeholder="Ingrese el RFC del afiliado">
                </div>
            </div>
            <div class="col-md-4 col-sm-12">
                <div class="form-group">
                    <label>Sitio web</label>
                    <input type="text" name="url" required class="form-control" placeholder="Ej: https://sitioweb.com">
                </div>
            </div>
            <div class="col-md-4 col-sm-12">
                <div class="form-group">
                    ...
                    <select name="id_nivel" required class="form-control select2">
                        ...
                        @foreach ($niveles as $nivel)
                            <option value="{{$nivel->id}}">{{$nivel->nombre}} ({{$nivel->comision}}%)</option>
                        @endforeach
                    </select>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" name="nombre_contacto" required class="form-control" placeholder="Ingresar Nombre contacto">
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
                <div class="form-group">
                    <label>Apellido contacto</label>
                    <input type="text" name="apellido_contacto" required class="form-control" placeholder="Ingresar Apellido contacto">
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
                ...
                <div class="input-group mb-3">
                    <div class="input-group mb-3">
                        <input name="telefono_oficina" id="telefono_oficina" required type="text" class="form-control" placeholder="Ingresar teléfono celular">
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
