...
@section('title', 'Editar costeo')

@section('content_header')
    <h1><span class="font-weight-bold">CloudTravel</span> | Editar costeo</h1>
@stop
...
@section('content')
    <div class="card card-info">
        ...
        <div class="card-body">
            <form id="form-editar-costeo" action="{{ route('costeos.update', $costeo->id) }}" method="post">
                @csrf
                @method('put')
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Ingresar nombre" value="{{ $costeo->nombre }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <textarea id="descripcion" name="descripcion" class="form-control" placeholder="Agregar una descripción para que los demás puedan identificar donde usar este costeo" style="height: 100px" required>{{ $costeo->descripcion }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div id="form-costeo__campos" class="form-costeo__campos">
                    ...
                    <div class="form-costeo__campo" style="margin-left: 42px">
                        <input type="hidden" name="costeo-campos-id[]" value="{{ $costeo->campos[0]->id }}">

                        <div class="form-group m-0">
                            <label class="m-0">Nombre</label>
                            <input type="text" name="costeo-campos-nombres[]" value="{{ $costeo->campos[0]->nombre }}" class="form-control" required>
                        </div>

                        <div class="form-group m-0">
                            <label class="m-0">Valor inicial</label>
                            <input type="number" name="costeo-campos-valores-por-defecto[]" value="{{ $costeo->campos[0]->valor_defecto }}" class="form-control" min="0" value="0" step="any" required>
                        </div>

                        <div class="form-group m-0">
                            <label class="m-0">Identificador</label>
                            <input type="text" name="costeo-campos-identificadores[]" value="{{ $costeo->campos[0]->identificador }}" class="form-control" disabled>
                        </div>
                        ...
                        <div class="form-group m-0 ">
                            ...
                            <select name="costeo-campos-dpu[]" class="form-control">
                                <option value="0" @if ($costeo->campos[0]->definido_por_usuario == 0) selected @endif>No</option>
                                <option value="1" @if ($costeo->campos[0]->definido_por_usuario == 1) selected @endif>Si</option>
                            </select>
                    ...
                    @foreach ($costeo->campos as $campo)
                        ...
                        @endif
                        <div class="form-costeo__campo" style="margin-left: 42px">
                            <input type="hidden" name="costeo-campos-id[]" value="{{ $campo->id }}">
                            ...
                            <div class="form-group m-0">
                                <label class="m-0">Nombre</label>
                                <input type="text" name="costeo-campos-nombres[]" value="{{ $campo->nombre }}" class="form-control" required>
                            </div>

                            <div class="form-group m-0">
                                <label class="m-0">Valor inicial</label>
                                <input type="number" name="costeo-campos-valores-por-defecto[]" value="{{ $campo->valor_defecto }}" class="form-control" min="0" value="0" step="any" required>
                            </div>

                            <div class="form-group m-0">
                                <label class="m-0">Identificador</label>
                                <input type="text" name="costeo-campos-identificadores[]" value="{{ $campo->identificador }}" class="form-control" disabled>
                            </div>
                            ...
                            <div class="form-group m-0">
                                ...
                                <select name="costeo-campos-dpu[]" class="form-control">
                                    <option value="0" @if ($campo->definido_por_usuario == 0) selected @endif>No</option>
                                    <option value="1" @if ($campo->definido_por_usuario == 1) selected @endif>Si</option>
                                </select>
                            </div>
                        </div>
                    @endforeach
                    ...
                    <div class="col-12">
                        <div class="form-group form-costeo__campo--mb-custom">
                            ...
                            <div class="form-costeo__campo-contenedor-formula">
                                <input type="text" name="formula_precio" value="{{ $costeo->formula_precio }}" class="form-control" data-input-formula required>
                ...
                <div id="form-costeo__condiciones" class="form-costeo__condiciones">
                    ...
                    @foreach ($costeo->condiciones as $condicion)
                        <div class="form-costeo__condicion form-costeo__condicion--mb-custom" style="margin-left: 42px">
                            <input type="hidden" name="costeo-condiciones-id[]" value="{{ $condicion->id }}">

                            <div class="form-group m-0">
                                <label class="m-0">Condición a cumplir</label>
                                <input type="text" name="costeo-condiciones[]" value="{{ $condicion->condicion }}" class="form-control">
                            </div>

                            <div class="form-group m-0">
                                <label class="m-0">Nueva formula</label>
                                <div class="form-costeo__campo-contenedor-formula">
                                    <input type="text" name="costeo-condiciones-formulas[]" value="{{ $condicion->formula_precio }}" class="form-control" data-input-formula required>
                                    <input type="text" class="form-control" disabled>
                                </div>
                            </div>
                        </div>
        ...
        <div class="card-footer d-grid gap-2 d-md-flex justify-content-md-end p-3">
            <button form="form-editar-costeo" class="btn btn-primary mx-3" type="submit">
                <i class="fas fa-pencil-alt"></i>
                &nbsp;Actualizar costeo
            </button>

            <a href="{{ route('costeos.index') }}" class="btn btn-danger">
        ...
        $(function() {
            ...
            function generarStringCosteoCampo(btnEliminar = false) {
                ...
                <div class="form-costeo__campo">
                    <input type="hidden" name="costeo-campos-id[]" value="${generateRandomString(20)}">
            ...
            function generarStringCosteoCondicion(btnEliminar = false) {
                ...
                <div class="form-costeo__condicion form-costeo__condicion--mb-custom">
                    <input type="hidden" name="costeo-condiciones-id[]" value="${generateRandomString(20)}">
            ...
            document.getElementById("form-editar-costeo").addEventListener("submit", (event) => {
