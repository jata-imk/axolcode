...
<h1><span class="font-weight-bold">CloudTravel</span> | Editar rol</h1>
@stop
...
@section('content')
    ...
    <div class="card card-info">
        ...
        <div class="card-body">
            <form id="form-editar-rol" @can('update', $rol) action="{{route('roles.update', $rol->id)}}" method="POST" @endcan>
                @can('update', $rol)
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input id="nombre" type="text" name="nombre" maxlength="63" class="form-control" placeholder="Ingresar nombre..." value="{{$rol->nombre}}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-sm-12" style="overflow-x: scroll; height: 80vh;">
                        <table id="dataTableRolMenus" class="table table-striped" style="border-radius: 7px; border-bottom: 1px solid #dee2e6; overflow: visible;">
                            ...
                            <tbody>
                                @php
                                    $rolesModulosArray = $rolesModulos->toArray();
                                    $columnIdMenuArray = array_column($rolesModulosArray, "id_menu")
                                @endphp

                                @foreach ($modulos as $i => $modulo)
                                    @php
                                        $searchId = array_search($modulo->id, $columnIdMenuArray);
                                    @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="border-left: 1px solid #dee2e6;">
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="checkbox" value="1" @php echo (( (($searchId !== false) ? $rolesModulos[$searchId]->crear : "0") == "1") || ($rol->nombre === "Administrador")) ?  "checked" : ""  @endphp id="{{$modulo->id}}-crear" name="{{$modulo->id}}-crear" data-checkbox-crear>
                                        ...
                                        <td class="text-center" style="border-left: 1px solid #dee2e6;">
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="checkbox" value="1" @php echo (( (($searchId !== false) ? $rolesModulos[$searchId]->ver : "0") == "1") || ($rol->nombre === "Administrador")) ?  "checked" : ""  @endphp id="{{$modulo->id}}-ver" name="{{$modulo->id}}-ver" data-checkbox-ver>
                                        ...
                                        <td class="text-center" style="border-left: 1px solid #dee2e6;">
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="checkbox" value="1" @php echo (( (($searchId !== false) ? $rolesModulos[$searchId]->editar : "0") == "1") || ($rol->nombre === "Administrador")) ?  "checked" : ""  @endphp id="{{$modulo->id}}-editar" name="{{$modulo->id}}-editar" data-checkbox-editar>
                                        ...
                                        <td class="text-center" style="border-left: 1px solid #dee2e6;">
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="checkbox" value="1" @php echo (( (($searchId !== false) ? $rolesModulos[$searchId]->eliminar : "0") == "1") || ($rol->nombre === "Administrador")) ?  "checked" : ""  @endphp id="{{$modulo->id}}-eliminar" name="{{$modulo->id}}-eliminar" data-checkbox-eliminar>
                                                    <label for="{{$modulo->id}}-eliminar" class="custom-control-label">&nbsp;</label>
                                                </div>
                                            </div>
                                        </td>

                                        <td class="text-center" style="border-left: 1px solid #dee2e6; border-right: 1px solid #dee2e6; width: 20px; padding-right: 0px;">
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
        ...
        <div class="card-footer d-grid gap-2 d-md-flex justify-content-md-end p-3">
            <button form="form-editar-rol" class="btn btn-primary mx-3" type="submit">
    ...
    <script>
        (function() {
            document.addEventListener("DOMContentLoaded", function() {
                ...
                const formulario = document.getElementById("form-editar-rol");
